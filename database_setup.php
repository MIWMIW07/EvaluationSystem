...
function insertAllTeacherAssignments($pdo) {
    ...
    $collegeTeachers = [
        ...
        'BSCS-1-SUNDAY CLASS' => ['MR. LACERNA', 'MR. PATIAM', 'MR. MATILA', 'MR. ESPEÑA', 'MR. VELE', 'MS. OCTAVO'],
        'BSCS-2-SUNDAY CLASS' => ['MR. ICABANDE', 'MR. PATIAM', 'MS. DIMAPILIS', 'MR. ESPEÑA', 'MR. RODRIGUEZ'],
        ...
        'BSOA-4N1' => ['MR. CALCEÑA'],
        'BSOA-1-SUNDAY CLASS' => ['MR. PATIAM', 'MR. MATILA', 'MR. RODRIGUEZ', 'MS. IGHARAS', 'MS. OCTAVO', 'MR. ICABANDE'],
        'BSOA-2-SUNDAY CLASS' => ['MR. PATIAM', 'MR. ICABANDE', 'MS. IGHARAS', 'MS. DIMAPILIS', 'MS. OCTAVO', 'MR. VELE', 'MR. LACERNA'],
